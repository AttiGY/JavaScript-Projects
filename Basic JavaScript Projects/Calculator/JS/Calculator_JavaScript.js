...
function Input_Digit(digit) {
    ...
    //to the kry that was clicked on.
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //If an operator exists, property lookup is performed for tge operator
...
//This functionupdates the calculator screen with the contents of Display_Value
